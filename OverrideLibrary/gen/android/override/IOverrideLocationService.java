...
public interface IOverrideLocationService extends android.os.IInterface {
     ...
     */
    public static abstract class Stub extends android.os.Binder implements android.override.IOverrideLocationService {
        ...
        /**
         * Cast an IBinder object into an android.override.IOverrideLocationService interface,
        ...
        public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException {
            switch (code) {
                ...
                case TRANSACTION_requestLocationUpdates: {
                    ...
                    _arg3 = android.override.IOverrideLocationListener.Stub.asInterface(data.readStrongBinder());
                ...
                case TRANSACTION_removeUpdates: {
                    ...
                    _arg0 = android.override.IOverrideLocationListener.Stub.asInterface(data.readStrongBinder());
...
// The following functions are visible to applications.
            ...
            public void requestLocationUpdates(java.lang.String packageName, java.lang.String provider, boolean singleShot, android.override.IOverrideLocationListener listener) throws android.os.RemoteException {
            ...
            public void removeUpdates(android.override.IOverrideLocationListener listener) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
            ...
            public android.location.Location getLastKnownLocation(java.lang.String packageName, java.lang.String provider) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
...
// The following functions are used by location providers.
            ...
            public void addOverrideProvider(java.lang.String overrideProvider) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
            ...
            public void removeOverrideProvider(java.lang.String overrideProvider) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
            ...
            public void reportOverrideLocation(java.lang.String overrideProvider, android.location.Location location) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
        ...
        static final int TRANSACTION_addOverrideProvider = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
        static final int TRANSACTION_removeOverrideProvider = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
        static final int TRANSACTION_reportOverrideLocation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
    }
// The following functions are visible to applications.
