...
public interface IOverrideSensorService extends android.os.IInterface {
     ...
     */
    public static abstract class Stub extends android.os.Binder implements android.override.IOverrideSensorService {
        ...
        /**
         * Cast an IBinder object into an android.override.IOverrideSensorService interface,
        ...
        public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException {
            switch (code) {
                ...
                case TRANSACTION_registerSensorDataListener: {
                    ...
                    _arg1 = android.override.IOverrideSensorDataListener.Stub.asInterface(data.readStrongBinder());
        ...
        private static class Proxy implements android.override.IOverrideSensorService {
            ...
            public void registerSensorDataListener(java.lang.String packageName, android.override.IOverrideSensorDataListener listener) throws android.os.RemoteException {
            ...
            public void enable_sensor(java.lang.String packageName, java.lang.String sensorName) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
            ...
            public void disable_sensor(java.lang.String packageName, java.lang.String sensorName) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
...
// The following functions are used by location providers.
            ...
            public void reportOverrideSensorData(java.lang.String overrideProvider, java.lang.String sensorName, float[] values, long nano_timestamp) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
        ...
        static final int TRANSACTION_registerSensorDataListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
        ...
        static final int TRANSACTION_reportOverrideSensorData = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
    }
